    ...
    <div className="fixed inset-0 bg-black/40 z-[9999] flex items-end animate-fade-in">
      <div className="bg-white dark:bg-bg-secondary w-full rounded-t-3xl shadow-2xl animate-slide-up transition-colors duration-200">
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-slate-100 dark:border-slate-700">
          <p className="font-black text-slate-800 dark:text-slate-100 text-sm">New Customer</p>
        ...
        <form onSubmit={e => { e.preventDefault(); name && onSave({ name, phone }) }} className="p-5 space-y-4">
          ...
          <div>
            <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase mb-1">Phone</label>

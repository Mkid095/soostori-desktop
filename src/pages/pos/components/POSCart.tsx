...
// ============================================================
// POS CART — right-side panel: items, prominent total, Hold/Pay.
// ============================================================
  ...
  <div className="w-72 bg-bg-secondary dark:bg-slate-900 border-l border-border-color dark:border-slate-700 flex flex-col shrink-0 transition-colors duration-200">
    ...
    <div className="px-3 py-2 border-b border-border-color dark:border-slate-700 flex items-center justify-between">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-xs font-black text-slate-700 dark:text-slate-200">Cart</span>
        {itemCount > 0 && (
    ...
    <div className="px-3 py-3 border-t border-border-color dark:border-slate-700 space-y-2.5 bg-bg-secondary dark:bg-slate-900 transition-colors duration-200">
      <div className="flex justify-between items-baseline px-1">
        ...
        <span className="text-2xl font-black text-brand-orange tabular-nums leading-none">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <button
          ...
          disabled={!cart.length}
          className="min-h-[44px] py-2.5 bg-brand-orange text-white rounded-xl font-bold text-xs hover:bg-orange-600 disabled:opacity-40 disabled:cursor-not-allowed shadow-md shadow-orange-200/60 dark:shadow-orange-900/40 flex items-center justify-center gap-1.5 transition-[background-color,box-shadow,transform] active:scale-[0.98]"
        >

...
export type ClientMessageType = 'HEARTBEAT' | 'GET_EVENTS_AFTER' | 'SALE_PENDING' | 'SALE_REFUNDED' | 'SALE_VOIDED'
  | 'STOCK_ADJUSTED' | 'PRODUCT_CREATED' | 'PRODUCT_UPDATED' | 'PRODUCT_DELETED'
  | 'CATEGORY_CREATED' | 'CATEGORY_UPDATED' | 'PRICE_CHANGED'

// Incoming events (server → client)
export type ServerEventType =
  | 'SALE_PENDING' | 'SALE_CONFIRMED' | 'SALE_REJECTED' | 'SALE_REFUNDED' | 'SALE_VOIDED'

...
import { CustomersRepository } from '@soostori/desktop-adapter'
...
export function registerCustomerHandlers(): void {
  // Wire adapter database to Electron's instance
  ...
  ipcMain.handle('db:customers:create', async (_event, rawData: unknown) => {
    ...
    // Return raw row for backward compatibility with renderer
    const db = getDatabase()
